...
WITHDRAW_VALUE FLOAT NOT NULL,
    CONSTRAINT CK_WITHDRAW_VALUE
    CHECK(WITHDRAW_VALUE>=0),
ACTIVE VARCHAR2(1) NOT NULL,
FK_USER INT NOT NULL,
...
INSERT INTO WITHDRAW (ID_WITHDRAW,DATE_WITHDRAW,DATE_OUTLAY,APPROVED,ACTIVE,WITHDRAW_VALUE,FK_USER) 
                        VALUES (1,'20-11-2015','21-11-2015', 'Y','Y',120000,'1') ;
...
INSERT INTO DEPOSIT (ID_DEPOSIT,TRANSACTION_DATE,STATUS,ACTIVE,DEPOSIT_VALUE,FK_USER,FK_PAY_CLASS) 
                        VALUES (1,'20-12-2018','PENDIENTE', 'Y',420000,'1','1') ;
SELECT * FROM DEPOSIT;
...
TOTAL_VALUE FLOAT,
    CONSTRAINT CK_VALIDATE_TOTAL_VALUE
    CHECK(TOTAL_VALUE <= 0),
TOTAL_PROFIT FLOAT,
STATUS VARCHAR(10),
...
CONSTRAINT CK_NAME_CATEGORY
    CHECK(NAME_CATEGORY = 'MAS/MENOS(0,5)' 
                    OR NAME_CATEGORY = 'MAS/MENOS(1,5)' 
...
BET_QUOTA INT NOT NULL,
    CONSTRAINT CK_BET_QUOTA
    CHECK(BET_QUOTA =1 OR BET_QUOTA = 2 OR BET_QUOTA =3),
...
INSERT INTO BET_DETAIL (ID_BET_DETAIL,BET_QUOTA,BET_VALUE,STATUS,ACTIVE,FK_QUOTA_MATCH,FK_BET) 
                        VALUES (1,2,20000,'PROGRESS','Y',1,1) ;           
...
CREATE OR REPLACE PROCEDURE END_MATCH(S VARCHAR2) IS 
    ...
    OPEN CR_PROFIT;
       -- LOOP
         --   EXIT WHEN CR_PROFIT%NOTFOUND;
            FETCH CR_PROFIT INTO  NAME_CATE,T_GOAL,T_GOALT1,T_GOALT2,H_GOALT1,H_GOALT2,W_QTA,Q1,Q2,Q3,BQ,BV,TP,BAL;
